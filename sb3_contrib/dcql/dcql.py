...
class DCQL(OffPolicyAlgorithm):
    """
    Discrete Conservative Q-Learning (DCQL)
    ...
    def learn(
        ...
        if self.experience_dataset:     # offline RL
            return super(DCQL,self)._learn_from_static_buffer(
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(DCQL, self)._excluded_save_params() + ["quantile_net", "quantile_net_target"]
